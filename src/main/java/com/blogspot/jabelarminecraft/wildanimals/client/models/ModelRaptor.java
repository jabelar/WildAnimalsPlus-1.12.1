...
public class ModelRaptor extends ModelWildAnimals {
	   ...
	   ModelRenderer head;
	    ...
	    /**
    	 * Instantiates a new model raptor.
    	 */
    	public ModelRaptor()
	    {
	    ...
	    /* (non-Javadoc)
    	 * @see com.blogspot.jabelarminecraft.wildanimals.client.models.ModelWildAnimals#setRotation(net.minecraft.client.model.ModelRenderer, float, float, float)
    	 */
    	@Override
